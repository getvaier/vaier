...
#### 6.15.1 One-call adoption ("Add a machine" — backend slices 1–2) 🟡 (in progress)
...
**Backlog (later slices):** the frontend Adopt button/flow and adopt sheet (with the credential test green-check) in the scan picker, adopting non-LAN-server discoveries, and bulk adoption.
