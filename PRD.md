...
#### 6.15.1 One-call adoption ("Add a machine" — slices 1–3) 🟡 (in progress)
...
**Backlog (later slices):** the peer branch's own intent reframe (Slice 4 — the "new box"/"personal device" fork and the connect recipe), adopting non-LAN-server discoveries, and bulk adoption.
