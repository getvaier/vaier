        ...
        return List.of(
            new ConceptGroup("Machines", List.of(
                ...
                Concept.of("Server peer",
                    "The Vaier server's own end of the VPN — the hub every client peer connects to.",
                    "There's one per network; its public key and address are what clients dial into."),
                ...
                Concept.of("Relay peer",
                    "A peer that forwards traffic for other peers behind it.",
                    "Set one up when devices can only reach the network through another machine."),
