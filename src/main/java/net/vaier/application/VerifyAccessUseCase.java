...
public interface VerifyAccessUseCase {
     ...
     * {@code connector_id}: {@code google}/{@code github}/{@code local}) is a recognised value it is
     ...
     * A sign-in through {@code local} — the first-run password — while no admin exists is the
     * first-run claim: that identity becomes the admin and is allowed.
     */
