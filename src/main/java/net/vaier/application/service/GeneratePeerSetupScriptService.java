...
public class GeneratePeerSetupScriptService implements GeneratePeerSetupScriptUseCase {
    ...
    private String generateScript(String peerName, String vpnIp, String serverUrl, String serverPort, String wgConfig) {
        ...
        sb.append("\n");
        sb.append("  netdata:\n");
        sb.append("    image: netdata/netdata:stable\n");
        sb.append("    container_name: netdata\n");
        sb.append("    network_mode: host\n");
        sb.append("    pid: host\n");
        sb.append("    restart: unless-stopped\n");
        sb.append("    cap_add:\n");
        sb.append("      - SYS_PTRACE\n");
        sb.append("      - SYS_ADMIN\n");
        sb.append("    security_opt:\n");
        sb.append("      - apparmor:unconfined\n");
        sb.append("    volumes:\n");
        sb.append("      - /etc/passwd:/host/etc/passwd:ro\n");
        sb.append("      - /etc/group:/host/etc/group:ro\n");
        sb.append("      - /proc:/host/proc:ro\n");
        sb.append("      - /sys:/host/sys:ro\n");
        sb.append("      - /etc/os-release:/host/etc/os-release:ro\n");
        sb.append("      - /var/run/docker.sock:/var/run/docker.sock:ro\n");
        sb.append("COMPOSE\n");
        sb.append("\n");
        ...
        sb.append("sudo iptables -D INPUT -p tcp --dport 19999 -j DROP 2>/dev/null || true\n");
        sb.append("sudo iptables -D INPUT -p tcp --dport 19999 -s 10.13.13.0/24 -j ACCEPT 2>/dev/null || true\n");
        sb.append("sudo iptables -A INPUT -p tcp --dport 19999 -s 10.13.13.0/24 -j ACCEPT\n");
        sb.append("sudo iptables -A INPUT -p tcp --dport 19999 -j DROP\n");
        sb.append("\n");
        ...
        sb.append("echo \"  Netdata:      http://$VPN_IP:19999 (firewalled to VPN subnet 10.13.13.0/24)\"\n");
        sb.append("echo \"\"\n");
