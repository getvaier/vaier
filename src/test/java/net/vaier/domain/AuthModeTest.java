...
class AuthModeTest {
    ...
    void wireValue_isTheLowercaseToken() {
        ...
        assertThat(AuthMode.AUTHELIA.wireValue()).isEqualTo("authelia");
    ...
    void fromString_parsesKnownTokensCaseInsensitively() {
        ...
        assertThat(AuthMode.fromString("Authelia")).isEqualTo(AuthMode.AUTHELIA);
        assertThat(AuthMode.fromString("SOCIAL")).isEqualTo(AuthMode.SOCIAL);
    }

    @Test
    void fromString_unknownOrBlankDefaultsToAuthelia_soAuthIsNeverAccidentallyDropped() {
        assertThat(AuthMode.fromString(null)).isEqualTo(AuthMode.AUTHELIA);
        assertThat(AuthMode.fromString("")).isEqualTo(AuthMode.AUTHELIA);
        assertThat(AuthMode.fromString("nonsense")).isEqualTo(AuthMode.AUTHELIA);
    }

    @Test
    void fromBoolean_mapsLegacyRequiresAuthToggle() {
        assertThat(AuthMode.fromRequiresAuth(true)).isEqualTo(AuthMode.AUTHELIA);
    ...
    void authMiddlewareNames_describeTheChainEachModeNeeds() {
        ...
        assertThat(AuthMode.AUTHELIA.authMiddlewareNames()).containsExactly("auth-middleware");
    ...
    void allAuthMiddlewareNames_unionAcrossEveryMode_soAModeSwitchCanStripThePriorChain() {
        assertThat(AuthMode.allAuthMiddlewareNames())
            .containsExactlyInAnyOrder("auth-middleware", "oauth2-signin", "oauth2-authn", "vaier-authz");
    }
    ...
    void fromMiddlewareNames_readsTheModeBackOffARoutersChain() {
        ...
        assertThat(AuthMode.fromMiddlewareNames(List.of("auth-middleware", "vaier-errors")))
    ...
    void isSocial_isTrueOnlyForSocial() {
        ...
        assertThat(AuthMode.AUTHELIA.isSocial()).isFalse();
