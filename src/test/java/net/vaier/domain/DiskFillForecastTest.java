...
class DiskFillForecastTest {
    ...
    void warrantsEarlyWarning_whenBelowLevelThresholdAndRunwayShort() {
        DiskFillForecast forecast = new DiskFillForecast("nas", 80, 1.0, Duration.ofHours(20));
    ...
    void warrantsEarlyWarning_false_whenRunwayBeyondHorizon() {
        DiskFillForecast forecast = new DiskFillForecast("nas", 80, 1.0, Duration.ofHours(30));
    ...
    void warrantsEarlyWarning_false_whenAtOrAboveLevelThreshold_soLevelAlertTakesOver() {
        ...
        DiskFillForecast atThreshold = new DiskFillForecast("nas", 85, 1.0, Duration.ofHours(10));
        DiskFillForecast aboveThreshold = new DiskFillForecast("nas", 90, 1.0, Duration.ofHours(2));
    ...
    void forecastSubject_namesMachineAndApproxRunwayHours() {
        DiskFillForecast forecast = new DiskFillForecast("nas", 82, 1.0, Duration.ofHours(18));
    ...
    void forecastBody_includesMachineCurrentRateRunwayAndUiLink() {
        String body = new DiskFillForecast("nas", 82, 1.5, Duration.ofHours(12)).forecastBody("example.com");
    ...
    void forecastBody_omitsUiLink_whenBaseDomainBlank() {
        String body = new DiskFillForecast("nas", 82, 1.5, Duration.ofHours(12)).forecastBody("  ");
