...
class LaunchpadRestControllerTest {
    ...
    void getServices_returnsLaunchpadServices() {
        var services = List.of(
            new LaunchpadServiceUco("app.example.com", null, "10.0.0.1", LaunchpadVisibility.VISIBLE_ACTIVE, null, "app"),
            new LaunchpadServiceUco("db.example.com", null, "10.0.0.2", LaunchpadVisibility.VISIBLE_ACTIVE, null, "db")
        );
